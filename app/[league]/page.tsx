      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0" }}>
        <div style={{ display: "flex", justifyContent: "flex-start", marginBottom: 18 }}>
          <a href="https://discord.gg/baWUsXWhdV"
            style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#5865f2", color: "white", padding: "10px 16px", borderRadius: 999, fontSize: 13, fontWeight: 800, textDecoration: "none", boxShadow: "0 12px 30px rgba(88,101,242,0.22)" }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 270px", gap: 20, marginBottom: 24, alignItems: "start" }}>
          ...
          <div>
            ...
            {upcomingGames.length === 0 ? (
              <div style={{ background: "#101318", border: "1px solid #1c2028", borderRadius: 12, padding: "28px 16px", textAlign: "center", color: "#2a2a2a", fontSize: 12 }}>No upcoming games scheduled.</div>
            ) : (
          ...
          <div>
            ...
            {recentGames.length === 0 ? (
              <div style={{ background: "#101318", border: "1px solid #1c2028", borderRadius: 12, padding: "28px 16px", textAlign: "center", color: "#2a2a2a", fontSize: 12 }}>No results yet.</div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
